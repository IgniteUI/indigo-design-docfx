...
_description: Figma UI ツールでフレームを作成する方法について説明します。
_keywords: デザインシステム, UI キット, Figma
_language: ja
---
...
- 検索を使用して Figma Community から Indigo.Design UI キットを取得し、[Open in Figma] 青いボタンをクリックしてファイルを複製します。
