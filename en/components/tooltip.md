...
The Tooltip comes with styling flexibility for background color and message text style. However, for the message text, it is recommended to use `white` with the dark variant and `grays.900` or `black` with the light variant, to assure optimal text legibility.
